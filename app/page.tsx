...
export default function Home() {
  return (
    <div className=" h-screen w-full overflow-hidden" >
      ...
      <div className="shadow bg-white p-5 md: p-2 rounded-2xl absolute top-0 md: bottom-28 bottom-0 left-0 right-0
      flex justify-center items-center flex-col m-auto max-h-fit max-w-fit min-w-max ">

        <p className="font-bold  text-center p-10 md:p-5 text-6xl md:text-5xl text-amber-500" >
          <Typewriter
              options={{
                strings: ['Weatheria'],
                autoStart: true,
        ...
        <p className="text-tremor-content placeholder-opacity-20 text-xs pl-5 pr-5">
          Powered by - ChatGpt(API), Next.js, Tailwind CSS , Tremor 2.0 , stepZen, open-meteo, etc!
          </p>

        <Divider className="my-10 mt-5 opacity-10"/>

        <div className="bg-gradient-to-r from-red-500 to-orange-500 rounded-xl min-w-full h-15 p-5 md: p-2">
          <CityPicker/>
        </div>
